...
public enum ErrorCode {
    ...
    // ===== Battle =====
    BATTLE_MOVES_NOT_DECIDED(HttpStatus.BAD_REQUEST, "BATTLE_400", "아직 선택이 내려지지 않은 배틀입니다."),
    BATTLE_WINNER_ALREADY_DECIDED(HttpStatus.CONFLICT, "BATTLE_409", "이미 승자가 확정된 배틀입니다.");
